#!/usr/bin/env python3
""" ImageNet Training Script for TransMix.
This script was modified from an early version of the PyTorch Image Models (timm)
(https://github.com/rwightman/pytorch-image-models)
Hacked together by Jieneng Chen and Shuyang Sun / Copyright 2022 ByteDance
"""
import argparse
import time
import yaml
...
# Dataset parameters
parser.add_argument('data_dir', default='./data/', type=str, metavar='DIR', # there is no default in timm!!!
...
parser.add_argument('--min-lr', type=float, default=1e-6, metavar='LR', # 1e-5 for vit
...
# new flags we added to timm.
parser.add_argument('--transmix', action='store_true', default=False, help='')
parser.add_argument('--total-batch-size', type=int, default=None,
                    help='input batch size for training (default: None), batch-size = total-batch-size / world_size')
def _parse_args():
